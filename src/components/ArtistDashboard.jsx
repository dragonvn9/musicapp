        ...
        <div className='view d-flex min-vh-100'>
            ...
            <div className='bg-white sidebar p-2' style={{ width: '220px' }}>
                <div className='m-2'>
                    ...
                    <span className='brand-name fs-4'>Artist Board</span>
                </div>
                ...
                <div className='list-group list-group-flush'>
                    ...
                    <Link to="/artist-dashboard/listener-users" className='list-group-item py-2'>
                        <i className='bi bi-people fs-5 me-2'></i>
                        <span className="fs-5">Listener Users</span>
                    </Link>
                    <Link to="/artist-dashboard/song-list" className='list-group-item py-2'>
